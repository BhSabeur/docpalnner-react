...
//import barcelona.png from "./assets";
//import curitiba.png from "./assets";.
//import istanbul.png from "./assets";
//import mexico-city.png from "./assets";
//import rome.png from "./assets";
//import rome.png from "./assets";
    ...
    <div>
      <div>
        ...
        <section className="first-intro">
          ...
          ></img>
          <span>Making the healthcare experience more human</span>
        </section>
        <div className="text1">
          <p>
      ...
      <div>
        <MainContent boxContent={boxContent} />
      </div>
      <div className="brands">
        <section class="brands">
          <div className="text3">
            <h7> We are a global company with local culture</h7>
          </div>
          <ul class="mylist">
            <li>
      ...
      <Offices cityOffices={cityOffices} />
      <div>
